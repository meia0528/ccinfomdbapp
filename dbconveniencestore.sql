...
CREATE TABLE `branch` (
  ...
  `performance_ratings` decimal(2,1) DEFAULT NULL,
...
CREATE TABLE `employees` (
  ...
  `employee_schedule` varchar(50) DEFAULT NULL,
...
CREATE TABLE `sales` (
  `product_id` int NOT NULL,
  `noted_by_employee_id` int DEFAULT NULL,
  `total_sales_made_daily` decimal(10,2) DEFAULT NULL,
  `sale_date` date DEFAULT NULL,
  PRIMARY KEY (`product_id`),
  KEY `noted_by_employee_id` (`noted_by_employee_id`),
...
CREATE TABLE `supplier` (
  ...
  `contract_terms_start_date` date DEFAULT NULL,
  `contract_terms_end_date` date DEFAULT NULL,
...
-- Dump completed on 2024-11-06  0:58:13
